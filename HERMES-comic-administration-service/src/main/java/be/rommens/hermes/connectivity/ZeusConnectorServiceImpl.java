...
@Slf4j
@Service
public class ZeusConnectorServiceImpl implements ZeusConnectorService {

    private final RestTemplate restTemplate;

    public ZeusConnectorServiceImpl(RestTemplateBuilder restTemplateBuilder, @Value("${service.zeus.hostname}") String zeusUri) {
